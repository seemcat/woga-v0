...
class WorkoutForm extends React.Component {
  ...
  toggleMuscle = ({ target: { value: muscle } }) => {
    this.setState({
      targets: Object.assign({}, this.state.targets, {
        [muscle]: !this.state.targets[muscle]
      })
    });
  };
  ...
  handleSave = () => {
    ...
    const selectedMuscles = Object.keys(allMuscles).filter(
      muscle => allMuscles[muscle]
    );

    const { addTempWorkout, mapWorkoutToTarget } = this.props;
